          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="needs-registration" @submit.prevent="formSubmit">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{ 'is-invalid': submitted && $v.form.caseName.$error }"
                      />
                      <div v-if="submitted && $v.form.caseName.$error" class="invalid-feedback">
                        <span v-if="!$v.form.caseName.required">This value is required.</span>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div>
                        <input
                          ...
                          :class="{ 'is-invalid': submitted && $v.form.caseNumber.$error }"
                        />
                        <div v-if="submitted && $v.form.caseNumber.$error" class="invalid-feedback">
                          <span v-if="!$v.form.caseNumber.required">This value is required.</span>
                          <span v-if="!$v.form.caseNumber.alphaNum">This value should be a valid Case Number.</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <button v-if="!submitted" class="btn btn-primary" type="submit">Submit case</button>
              </form>
            </div>
          </div>
        </div>
