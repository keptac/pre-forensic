...
import newFraudsData from '../../../assets/data/fraud-alerts.json';
import {
...
export default {
  data() {
    return {
      ...
      fields: [
        ...
        { key: "fraudType", sortable: true, label: "Fraud Type" },
        { key: "entity", sortable: true, label: "Entity" },
        { key: "riskScore", sortable: true, label: "Risk Score" },
        { key: "confidence", sortable: true, label: "Confidence" },
        { key: "status", sortable: true, label: "Status" },
        { key: "action", sortable: false, label: "Action" }
      ],
      columns: [
        { field: "fraudType", label: "Fraud Type" },
  ...
  methods: {
    ...
    async loadAllKeywords() {
      ...
      //     this.keywordsData = newFraudsData;
