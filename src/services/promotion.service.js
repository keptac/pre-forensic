...
async function getAllPromotions() {
    ...
    return fetch(`${ackremittancesServiceEndpoint}/rewards`, requestOptions)
        .then(handleResponse)
        .then(response => {
            return response;
        })
...
async function addPromotion(advertisement) {
    ...
    return fetch(`${ackremittancesServiceEndpoint}/reward/save`, requestOptions)
        .then(handleResponse)
        .then(response => {
            return response;
        })
